package com.hongyan.learn.test.leetcode.answers;/*
                                                 ...
                                                 * binary tree, 1 / \ 2 3 / \ / \ 4 5 6 7 After calling your function,
                                                 * the tree should look like: 1 -> NULL / \ 2 -> 3 -> NULL / \ / \
                                                 * 4->5->6->7 -> NULL
                                                 * 
                                                 */
...
/**
 * Definition for binary tree with next pointer. public class TreeLinkNode { int val; TreeLinkNode left, right, next;
