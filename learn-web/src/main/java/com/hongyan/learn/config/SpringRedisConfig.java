...
public class SpringRedisConfig {
    ...
    @Bean
    public JedisConnectionFactory jedisConnectionFactory(@Value(value = "${redis.host}") String hostName,
        @Value(value = "${redis.port}") Integer port, @Value(value = "${redis.pass}") String password,
        @Value(value = "${redis.timeout}") Integer timeout, @Value(value = "${redis.default.db}") Integer database,
